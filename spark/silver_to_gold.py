...
def main():
    ...
    spark = SparkSession.builder \
        .appName("RetailFlow_Silver_to_Gold") \
        .master("local[*]") \
        .getOrCreate()
    ...
    df_fact_sales = df_orders.join(df_dim_product, df_orders.ProductID == df_dim_product.ProductID_BK, "left") \
        .join(df_dim_customer, df_orders.CustomerID == df_dim_customer.CustomerID_BK, "left")
